...
class BookingsController extends Controller
{
    ...
    public function update(BookingRequest $request, $id)
    {
        ...
        //$this->checkAvailableReservationsAndDates($request, $cabin);
        ...
        if($monthBegin < $monthEnd) {
            if($dateDifference->days <= 60) {
                    ...
                    foreach ($generateBookingDates as $generateBookingDate) {
                        ...
                        if($cabinDetails->sleeping_place != 1) {
                            if( ((int)$request->$beds[$tb] + (int)$request->$dormitory[$tb]) === ((int)$request->$guests[$tb] + (int)$request->$no_guides[$tb]) )
                            {
                                    ...
                                    if(in_array($dates, $not_regular_dates)) {
                                        ...
                                        if(($totalBeds < $cabinDetails->not_regular_beds) || ($totalDorms < $cabinDetails->not_regular_dorms)) {
                                            ...
                                            if($bedsRequest <= $not_regular_beds_avail) {
                                                ...
                                                $availableStatus[] = 'notAvailable';
                                                return back()->with('error', $bedsRequest.__("tours.bedsNotAvailable").$generateBookingDate->format("d.m"));
                                            }
                                            ...
                                            if($dormsRequest <= $not_regular_dorms_avail) {
                                                ...
                                                $availableStatus[] = 'notAvailable';
                                                return back()->with('error', $dormsRequest.__("tours.dormsNotAvailable").$generateBookingDate->format("d.m"));
                                            }
                                            ...
                                            if($cabinDetails->not_regular_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->not_regular_inquiry_guest) {
                                                ...
                                                return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->not_regular_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                            }
                                        }
                                        else {
                                            $availableStatus[] = 'notAvailable';

                                            return back()->with('error', __("tours.alreadyFilledBedsDorms").$generateBookingDate->format("d.m"));
                                        }
                                    }
                                }
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->mon_beds) || ($totalDorms < $cabinDetails->mon_dorms)) {
                                                ...
                                                if($cabinDetails->mon_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->mon_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->mon_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->tue_beds) || ($totalDorms < $cabinDetails->tue_dorms)) {
                                                ...
                                                if($cabinDetails->tue_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->tue_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->tue_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->wed_beds) || ($totalDorms < $cabinDetails->wed_dorms)) {
                                                ...
                                                if($cabinDetails->wed_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->wed_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->wed_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->thu_beds) || ($totalDorms < $cabinDetails->thu_dorms)) {
                                                ...
                                                if($cabinDetails->thu_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->thu_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->thu_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->fri_beds) || ($totalDorms < $cabinDetails->fri_dorms)) {
                                                ...
                                                if($cabinDetails->fri_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->fri_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->fri_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->sat_beds) || ($totalDorms < $cabinDetails->sat_dorms)) {
                                                ...
                                                if($cabinDetails->sat_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->sat_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->sat_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                            }
                                            else {
                                                $availableStatus[] = 'notAvailable';
                                        ...
                                        if(!in_array($dates, $dates_array)) {
                                            ...
                                            if(($totalBeds < $cabinDetails->sun_beds) || ($totalDorms < $cabinDetails->sun_dorms)) {
                                                ...
                                                if($cabinDetails->sun_inquiry_guest > 0 && $requestBedsSumDorms >= $cabinDetails->sun_inquiry_guest) {
                                                    ...
                                                    return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->sun_inquiry_guest - 1).__("tours.bookingLimitReachedTwo"));
                                                }
                                ...
                                if(!in_array($dates, $dates_array)) {
                                    if(($totalBeds < $cabinDetails->beds) || ($totalDorms < $cabinDetails->dormitory)) {
                                        ...
                                        if($cabinDetails->inquiry_starts > 0 && $requestBedsSumDorms >= $cabinDetails->inquiry_starts) {
                                            ...
                                            return back()->with('error', __("tours.bookingLimitReached").$generateBookingDate->format("d.m").__("tours.bookingLimitReachedOne").($cabinDetails->inquiry_starts - 1).__("tours.bookingLimitReachedTwo"));
                                        }
                                    }
                                    else {
                                        $availableStatus[] = 'notAvailable';
                                ...
                                return back()->with('error', __("tours.bedsDormsNotMatchGuestGuide"));
                            }
                        }
                        else {
                            if( (int)$request->sleeps === ((int)$request->guests + (int)$request->guides) ) {
                                    ...
                                    if(in_array($dates, $not_regular_dates)) {
                                        ...
                                        if(($totalSleeps < $cabinDetails->not_regular_sleeps)) {
                                            ...
                                            if($sleepsRequest <= $not_regular_sleeps_avail) {
                                                ...
                                                $availableStatus[] = 'notAvailable';
                                                return back()->with('error', $sleepsRequest.__("tours.sleepsNotAvailable").$generateBookingDate->format("d.m"));
                                            }
                                            ...
                                            return back()->with('error', __("tours.alreadyFilledSleeps").$generateBookingDate->format("d.m"));
                                        }
                                    }
                                }
                                ...
                                return back()->with('error', __("tours.sleepsNotMatchGuestGuide"));
                            }
                        }
                    }
                }
                ...
                return back()->with('error', __("tours.sixtyDaysExceed"));
            }
        }
        else {
            //return back()->with('failureMsg' =>  __('tours.dateGreater'));
            return back()->with('error', __("tours.dateGreater"));
        }

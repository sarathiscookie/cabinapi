...
class MountSchoolUsersController extends Controller
{
    ...
    public function dataTables(Request $request)
    {
        ...
        {
            $q->where(function($query) use ($params) {
                $query->where('usrName', 'like', "%{$params['columns'][2]['search']['value']}%");
            });

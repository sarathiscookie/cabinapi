        ...
        if(!empty($bookings))
        {
            foreach ($bookings as $key=> $booking)
            {
                ...
                if($bookings[$key]['usrEmail'] == 'cabinowner') {
                    ...
                    $sendVoucherHtml = '<button class="btn btn-primary btn-sm sendInvoice" data-loading-text="'.__('admin.sendingProcess').'" autocomplete="off"><i class="fa fa-envelope"></i> '.__("admin.sendButtonLabel").'</button>';

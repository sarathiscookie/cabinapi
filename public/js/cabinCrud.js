...
$(document).ready(function () {
 /* for add other neibhour cabins*/
    ...
    $(".add-more-dynamic , .addNeighbourlbl").click(function (e) {
        ...
        //    var newIn = '<input autocomplete="off" class="input form-control other-neighbour-cabin" id="other_neighbour_cabin' + next + '" name="'+field_name+'" type="text" /><input  class="input form-control other-neighbour-cabin"   name="'+field_url_name+'" type="text"><button id="remove' + (next  ) + '" class="btn btn-danger remove-me" for="' + (next  ) +'" >-</button></div><div id="field">';

...
<div class="modal fade updateBalanceModel_'.$userList->_id.'" tabindex="-1" role="dialog" aria-labelledby="updateBalanceSmallModalLabel"><div class="modal-dialog modal-sm" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title">'.__("userList.balanceUpdateHeading").'</h4></div><div class="responseBalanceStatusMessage"></div><div class="modal-body"><div class="row"><div class="col-md-3"><input class="form-control input-sm" id="money_balance_updated_'.$userList->_id.'" type="text" value="'.$userList->money_balance.'"></div><div class="col-md-6"><textarea class="form-control" id="money_balance_message_'.$userList->_id.'"></textarea></div><div class="col-md-3"><a class="btn btn-primary btn-sm balanceUpdateButton" data-id="'.$userList->_id.'">'.__("userList.balanceUpdateButton").'</a></div></div></div><div class="modal-footer"><button type="button" class="btn btn-default btn-sm" data-dismiss="modal">'.__("userList.balanceUpdateCloseButton").'</button></div></div></div></div>
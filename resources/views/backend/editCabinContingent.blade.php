                                        ...
                                        <div class="box-body">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group {{ $errors->has('not_regular_date') ? ' has-error' : '' }}">
                                                    ...
                                                    <input type="text" readonly="readonly" class="form-control" id="daterange" name="not_regular_date" value="{{old('not_regular_date', $cabin->not_regular_date)}}" placeholder="@lang('cabins.daterangepickerPlaceholder')">

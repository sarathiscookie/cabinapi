                                                        ...
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p>Sehr geehrter {{ $firstname }} {{ $lastname }},<br>
                                                                    ...
                                                                    Wir bitten Sie daher, sich in Ihrem Backendbereich erneut einzuloggen, und unter dem Menuepunkt „Meine Buchungen“ die Zahlung nochmals durchzufuehren. Klicken Sie hierzu auf „Zahlung erneut durchfuehren“.<br /><br />

                                                                    Aktive Buchungen erkennen Sie an dem Buchungsstatus „Buchung fix“.<br /><br />

                                                                    Sollten Sie noch weitere Fragen haben koennen Sie uns gerne eine E-Mail schreiben: service@huetten-holiday.de <br /><br />
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                                            <a class="mcnButton " title="Zu meinen Buchungen" href="http://www.huetten-holiday.de/guest/index/bookings/{{ $userID }}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Zu meinen Buchungen</a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <em>Copyright © 2017 Huetten-Holiday.de GbR, All rights reserved.</em><br>
                                                                <br>

                                                                Huetten-Holiday.de<br>
                                                                Hofer, Hofer & Michel GbR<br>
                                                                Nebelhornstraße 3<br>

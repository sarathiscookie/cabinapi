...
<div class="wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="/cabinowner/create/booking"><i class="fa fa-circle-o"></i>@lang('menu.createBooking')</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/cabinowner/statistics/guests"><i class="fa fa-circle-o"></i> @lang('menu.guestStatistics')</a></li>
                    </ul>
                </li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ date('Y') }} <a href="#">Huetten-Holiday</a>.</strong> All rights
        reserved.
    </footer>
